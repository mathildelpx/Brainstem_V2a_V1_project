...
condition_movement = ops['xoff'] < np.percentile(ops['xoff'], 2)
...
analysis_log['condition_ma'] = "ops['xoff'] > np.percentile(ops['xoff'], 2)"
...
TA_all = np.load(output_path+'np_array/'+fishlabel+'/'+depth+'/overall_ta.npy')
